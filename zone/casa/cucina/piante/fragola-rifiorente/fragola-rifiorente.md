...
attivita:
  irrigazione:
    ...
    estate: quotidiana se fa caldo
    autunno: ogni 3-4 giorni
    inverno: minima, solo se il substrato è asciutto
  concimazione:
    primavera: ogni 2 settimane con concime per fragole o piante da frutto
