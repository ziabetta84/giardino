...
attivita:
  irrigazione:
    ...
    estate: cambiare l’acqua ogni 3-5 giorni
    autunno: cambiare l’acqua ogni 7 giorni
    inverno: cambiare l’acqua ogni 10 giorni
  concimazione:
    primavera: 2-3 gocce di fertilizzante liquido ogni 30 giorni (facoltativo)
    estate: 2-3 gocce ogni 30 giorni
    autunno: sospesa
    inverno: sospesa
  potatura:
