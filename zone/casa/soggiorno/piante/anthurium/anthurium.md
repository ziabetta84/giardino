...
attivita:
  irrigazione:
    ...
    estate: ogni 4-6 giorni, aumentare umidità ambientale
    autunno: ogni 6-8 giorni
    inverno: ogni 8-12 giorni, evitare acqua fredda
  concimazione:
    primavera: ogni 2 settimane con concime per piante da fiore
