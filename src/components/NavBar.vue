...
.nav-item:hover::before { opacity: 0.65; transform: scaleX(1); }
.nav-item.router-link-active { color: var(--rose); font-weight: 600; }
.nav-item.router-link-active::before { opacity: 0.85; transform: scaleX(1); }
.nav-badge {
